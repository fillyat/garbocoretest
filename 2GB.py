...
def roundStart(players, roundTime, bigrams, trigrams, useTri):
    for i in range(len(players)):
        # NEW: Generate a fresh ngram and display it for each turn
...
# -----------------------------------------------------------------------------
# Initialise pygame mixer and load n-grams
# -----------------------------------------------------------------------------
pygame.mixer.init()
...
def main():
    ...
    # Game finished; clear display so launcher can draw next screen
    display_clear()
